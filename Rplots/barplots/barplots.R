...
frequencies$feature <- factor(frequencies$feature,
                              levels = c("e=1", "e=1, caps", "e=1, no caps", "e=1, explicit", "e=1, implicit",
                                         ...
                                         "rel=1, explicit", "rel=1, implicit", "rel=1, present",
                                         "rel=1, not present", "rel=1, wc=1", "rel=1, wc=2", "rel=1, wc>2",
                                         "rel=2, 0 hidden", "rel=2, 1 hidden", "rel=2, 2 hidden",
                                         "rel=2, 0 explicit", "rel=2, 1 explicit", "rel=2, 2 explicit",
                                         "rel=2, av. wc=0.5", "rel=2, av. wc=1", "rel=2, av. wc=1.5", "rel=2, av. wc=2",
